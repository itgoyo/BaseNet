...
public class StatusBarUtil {
    ...
    public static void setStatusBar(Activity mActivity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                setColor(mActivity, Color.parseColor("#00FFFFFF"), 0);
        } else {
    ...
    private static void setStatusBarColor(Activity mActivity) {
        ...
        tintManager.setTintColor(Color.parseColor("#ff00bafe"));
        tintManager.setTintAlpha(100f);
        // set a custom tint color for navigation bar
